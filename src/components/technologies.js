...
const Technologies = () => {
	return (
		<div className='technologies'>
			...
			<div className='tech-item'>
				<img src='devicons/javascript.svg' alt='javascript' className='devicon'></img>
				<p>JavaScript</p>
			</div>
			<div className='tech-item'>
			...
			<div className='tech-item'>
				<img src='devicons/express.svg' alt='express' className='devicon'></img>
				<p>Express</p>
			</div>
			<div className='tech-item'>
			...
			<div className='tech-item'>
				<img src='devicons/postgresql.svg' alt='postgresql' className='devicon'></img>
				<p>PostgreSQL</p>
			</div>
		</div>
	);
