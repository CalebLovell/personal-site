...
const colors = ["lightgrey", "white", "grey"]
...
class Home extends Component {
  ...
  makeCircles(radius, x, y, dx, dy, color) {
      ...
      update: function() {
        ...
        if (
          ...
          if (this.radius < maxRadius) {
            ...
            if (
              this.x + maxRadius + innerGrowth < self.canvasRef.current.width &&
              this.y + maxRadius + innerGrowth <
  ...
  init() {
    ...
    for (let i = 0; i < numberOfCircles; i++) {
      ...
      circleArray.push(this.makeCircles(radius, x, y, dx, dy, color))
    }
  }
      ...
      <section className="home">
        <div className="canvas-container">
          <canvas
            ...
            onMouseMove={e => this.setState({ mousePosition: { x: e.nativeEvent.offsetX, y: e.nativeEvent.offsetY } })}
          />
        </div>
        <div className="intro-container">
          <h1>Hello, I'm Caleb Lovell.</h1>
