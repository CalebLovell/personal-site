		...
		if (name !== `` && email !== `` && message !== ``) {
			fetch(`/`, {
				...
				.catch(error =>
					Swal.fire({
						title: `Error`,
						text: `Sorry! Something went wrong. You can email me directly at caleblovell1@gmail.com or reach me through one of my social links below. Sorry for the inconvenience!`,
						type: error,
						confirmButtonText: `OK`,
						confirmButtonColor: `rgb(214, 28, 81)`,
					}),
	...
	return (
		<section className='contact' id='contact'>
			...
			<form name='contact' method='post' data-netlify='true' netlify-honeypot='bot-field' onSubmit={handleSubmit}>
				...
				<input type='hidden' name='bot-field' value="Don't fill this out if you're a human." />
