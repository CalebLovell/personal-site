...
const lyricsLogImages = [lyricslogHome, lyricslogSong, lyricslogLogin, lyricslogProfile, lyricslogAdd];
				...
				<div className='card-grid'>
					...
					>
						<div className={`card ${projectActiveClass1}`}>
							<img src={usacountyexplorerHome} alt='USA County Explorer Home Page'></img>
							<div>
